...
namespace JumpPoint.Uwp.Helpers
{
    public class ServiceLocator : ViewModelLocator
    {
        ...
        public ServiceLocator()
        {
...
#endif
            SimpleIoc.Default.Register<IAddOnService>(() => addOnService);

            // Register Icon Resource
            var iconResources = new ResourceService<Uri>();

            // Register Helpers
            SimpleIoc.Default.Register<ITileIconHelper, TileIconHelper>();
            ...
            SimpleIoc.Default.Register<IShortcutService, ShortcutService>();
