...
{
    public class ScrollIncreaseButtonBehavior : Behavior<RepeatButton>
    {
        ...
        private void AssociatedObject_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (scrollViewer != null)
            {
                scrollViewer.ChangeView(Math.Min(scrollViewer.ScrollableWidth, scrollViewer.HorizontalOffset + 50), null, null);
            }
        }
