...
{
    public sealed partial class ClipboardManagerPage : PageBase
    {
        public ClipboardManagerPage()
        {
            this.InitializeComponent();
            this.DataContext = ViewModelLocator.Instance.GetUniqueInstance<ClipboardManagerViewModel>();

            var appView = ApplicationView.GetForCurrentView();
            appView.SetPreferredMinSize(new Size(400, 400));
            appView.TryResizeView(new Size(400, 400));
        ...
        public ClipboardManagerViewModel ViewModel => DataContext as ClipboardManagerViewModel;
