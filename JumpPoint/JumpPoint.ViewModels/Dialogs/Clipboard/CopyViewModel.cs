...
{
    public class CopyViewModel : ObservableObject
    {
        private readonly IDialogService dialogService;

        public CopyViewModel(IDialogService dialogService, DirectoryBase destination, IList<StorageItemBase> items)
        {
        ...
        public async Task Start()
        {
            ...
            {
                CurrentItem = Items[i];
                await StorageService.CopyItem(Destination, CurrentItem);
